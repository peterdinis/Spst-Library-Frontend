...
import { getUserProfile, logoutUser, type UserProfileDto } from "@/functions/auth/authFunctions";
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="hidden md:block text-left">
                                <div className="flex items-center gap-2">
                                    ...
                                    {userProfile.roles && userProfile.roles.map(role => (
                                        <Badge
                                            key={role}
                                            variant="outline"
                                            className={cn(
                            ...
                            {isLoggedIn && userProfile ? (
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex items-center gap-2 text-sm">
                                                        ...
                                                        <span>Posledné prihlásenie: {formatDate(userProfile.lastLogin)}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="p-6">
                                    <div className="text-center space-y-4">
                                        ...
                                        <div>
                                            <h3 className="font-bold text-lg mb-2">Nie ste prihlásený</h3>
